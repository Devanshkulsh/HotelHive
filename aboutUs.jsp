...
<body class="bg-light">
        ...
        <p class="text-center mt-3 "><%= site_about %></p>
    </div>
    <!-- About US -->
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
                ...
                <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sit illum excepturi nesciunt. Iusto,
                    pariatur saepe.
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sit illum excepturi nesciunt. Iusto,
                    pariatur saepe.
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sit illum excepturi nesciunt. Iusto,
